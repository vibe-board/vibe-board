...
When you add a repository to a workspace, Vibe Board creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.vibe-board-workspaces` directory (configurable in Settings).
</Accordion>

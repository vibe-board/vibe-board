...
description: "Learn how to create and configure projects in Vibe Board"
---
...
Vibe Board supports two workspace modes for running coding agents:
...
- **CARGO_TARGET_DIR**: Vibe Board automatically sets `CARGO_TARGET_DIR` to share build artifacts across worktrees

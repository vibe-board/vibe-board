...
Vibe Kanban includes an integrated terminal panel that gives you shell access directly within the task view. You can open it as a right-panel mode alongside the task conversation.

...
When merging, Vibe Kanban generates a [Conventional Commits](https://www.conventionalcommits.org/)-style commit message from the diff. You can configure which agent generates this message in **Settings → General → Commit Message Agent**.

...
description: "Solutions for common issues with Vibe Board Cloud"
---

This page covers common issues you might encounter with Vibe Board Cloud and how to resolve them.
...
4. Return to Vibe Board and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Vibe Board (`npx vibe-board`)
</Accordion>
...
1. **Check existing issues:** [github.com/BloopAI/vibe-board/issues](https://github.com/BloopAI/vibe-board/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/BloopAI/vibe-board/issues/new">

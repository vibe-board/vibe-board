---
title: "Vibe Board Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
Vibe Board Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is Vibe Board Cloud?

**Vibe Board Cloud** adds team collaboration to Vibe Board. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Vibe Board interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Vibe Board installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Vibe Board** as usual with `npx vibe-board`
...
Think of it as your company or team in Vibe Board.
...
- Review code directly in Vibe Board
- Track PR status

## Getting Started

<Steps>
<Step title="Run Vibe Board">
  ```bash
  npx vibe-board
  ```
</Step>

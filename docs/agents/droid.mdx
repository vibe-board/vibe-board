...
icon: https://www.vibeboard.cloud/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Vibe Board, you must first authenticate:
...
Droid supports several configuration options in Vibe Board:
...
These options can be configured when creating agent configurations in Vibe Board.

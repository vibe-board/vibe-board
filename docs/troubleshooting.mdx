...
description: "Common issues and solutions when using Vibe Board"
---
...
If you encounter irrecoverable errors and need to completely wipe your Vibe Board database, you can delete the application data directory for your operating system.
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.bloop.vibe-board/
```
</Tab>

<Tab title="Linux">
```bash
~/.local/share/vibe-board/
```
</Tab>

<Tab title="Windows">
```
%APPDATA%\bloop\vibe-board\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\vibe-board\`
</Tab>
</Tabs>

After deleting the application data directory, restart Vibe Board to reset with an empty database and default settings.

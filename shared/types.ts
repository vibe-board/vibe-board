...
export type WorkspaceRepo = { id: string, workspace_id: string, repo_id: string, target_branch: string, parent_workspace_repo_id: string | null, nested_path: string | null, created_at: Date, updated_at: Date, };

export type CreateWorkspaceRepo = { repo_id: string, target_branch: string, };

export type RepoWithTargetBranch = { target_branch: string, is_nested: boolean, id: string, path: string, name: string, display_name: string, setup_script: string | null, cleanup_script: string | null, archive_script: string | null, copy_files: string | null, parallel_setup_script: boolean, dev_server_script: string | null, default_target_branch: string | null, default_working_dir: string | null, 
/**
 * Snake-case ProviderKind ('git_hub' | 'azure_dev_ops' | 'git_lab') set by the user;
 * NULL = auto-detect via URL heuristic + glab probe. Validated at the server layer.
 */
...
export type Task = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_workspace_id: string | null, created_at: string, updated_at: string, has_in_progress_attempt: boolean, last_attempt_failed: boolean, executor: string, variant: string | null, };

export type PaginatedTaskHistory = { tasks: Array<Task>, total_count: bigint, has_more: boolean, };
...
export type Workspace = { id: string, task_id: string, container_ref: string | null, branch: string, agent_working_dir: string | null, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, mode: WorkspaceMode, };

export type WorkspaceWithStatus = { is_running: boolean, is_errored: boolean, id: string, task_id: string, container_ref: string | null, branch: string, agent_working_dir: string | null, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, mode: WorkspaceMode, };
...
export type ExecutionProcessRunReason = "setupscript" | "cleanupscript" | "archivescript" | "codingagent" | "commitmessage" | "devserver";
...
export type ApprovalInfo = { approval_id: string, tool_name: string, execution_process_id: string, task_id: string, is_question: boolean, created_at: string, timeout_at: string, };
 ...
 */
allow_executor_change: boolean | null, };
...
export type MergeTaskAttemptRequest = { repo_id: string, session_id: string, executor_profile_id: ExecutorProfileId, commit_message_executor_profile_id: ExecutorProfileId | null, commit_message_enabled: boolean, commit_message_single_commit: boolean, };
...
export type CreateAndStartTaskRequest = { task: CreateTask, executor_profile_id: ExecutorProfileId, repos: Array<WorkspaceRepoInput>, workspace_mode?: WorkspaceMode, initial_context?: string, };

export type ConversationContextResponse = { context: string | null, };
...
export type CreateTaskAttemptBody = { task_id: string, executor_profile_id: ExecutorProfileId, repos: Array<WorkspaceRepoInput>, workspace_mode?: WorkspaceMode, };
...
export type ClaudeCode = { append_prompt: AppendPrompt, claude_code_router?: boolean | null, plan?: boolean | null, approvals?: boolean | null, model?: string | null, agent?: string | null, dangerously_skip_permissions?: boolean | null, disable_api_key?: boolean | null, continuous: boolean | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
...
export type Cline = { append_prompt: AppendPrompt, yolo?: boolean | null, model?: string | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
...
export type Kilo = { append_prompt: AppendPrompt, yolo?: boolean | null, model?: string | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };

...
#[async_trait]
impl StandardCodingAgentExecutor for Deepagents {
    ...
    async fn spawn(
        ...
        let harness = AcpAgentHarness::with_session_namespace("deepagents_sessions");
    ...
    fn default_mcp_config_path(&self) -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|home| home.join(".deepagents").join("settings.json"))
    }

...
#[async_trait]
impl StandardCodingAgentExecutor for PiAcp {
    ...
    async fn spawn(
        ...
        let harness = AcpAgentHarness::with_session_namespace("pi_acp_sessions");
    ...
    fn default_mcp_config_path(&self) -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|home| home.join(".pi").join("settings.json"))
    }

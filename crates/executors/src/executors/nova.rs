...
#[async_trait]
impl StandardCodingAgentExecutor for Nova {
    ...
    async fn spawn(
        ...
        let harness = AcpAgentHarness::with_session_namespace("nova_sessions");
    ...
    fn default_mcp_config_path(&self) -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|home| home.join(".nova").join("settings.json"))
    }

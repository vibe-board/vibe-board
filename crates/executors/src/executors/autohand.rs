...
#[async_trait]
impl StandardCodingAgentExecutor for Autohand {
    ...
    async fn spawn(
        ...
        let harness = AcpAgentHarness::with_session_namespace("autohand_sessions");
    ...
    fn default_mcp_config_path(&self) -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|home| home.join(".autohand").join("settings.json"))
    }

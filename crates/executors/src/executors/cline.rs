...
#[async_trait]
impl StandardCodingAgentExecutor for Cline {
    ...
    async fn spawn(
        ...
        let harness = AcpAgentHarness::with_session_namespace("cline_sessions");
    ...
    fn default_mcp_config_path(&self) -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|home| home.join(".cline").join("settings.json"))
    }
